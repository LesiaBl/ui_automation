...
/*
  ...
  */
    ...
    public void validateErrorMessage(){
        ...
        usernameInputBox.sendKeys("johnnnnhrbfgadjuhvueifhvoeiruhrvn@gmail.com");
        passwordInputBox.sendKeys("1234");
        loginButton.click();

        WebElement message = driver.findElement(By.cssSelector("._9ay7"));
        Assert.assertTrue(message.isDisplayed());
        Assert.assertEquals(message.getText(),"The email you entered isn’t connected to an account. Find your account and log in.");
